    ...
    <div class="space-y-3 md:col-span-3">
      <div>
        <input
          ...
          onkeydown={onKeyDown}
          class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
          placeholder="Title *"
          required
        />
      </div>
    ...
    <div class="flex flex-col md:col-span-1">
      <div class="relative mb-3">
        <select
          ...
          class="w-full appearance-none rounded-md border border-gray-300 bg-white px-3 py-2 pr-12 text-gray-900 focus:ring-2 focus:ring-blue-500 focus:outline-none dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
        >
          {#if !projectId}
      ...
      <div class="mt-2 flex items-center justify-end gap-2 md:mt-auto">
        <button
          type="button"
          class="btn btn-base bg-gray-200 text-gray-700 dark:bg-gray-600 dark:text-gray-300"
          onclick={handleCancel}
          disabled={submitting}>Cancel</button
        >
        <button
          type="submit"
          class="btn btn-base bg-blue-500 text-white hover:bg-blue-600 disabled:opacity-50"
          disabled={submitting || !title.trim()}>Save</button
        >
      </div>
    </div>
  </div>
