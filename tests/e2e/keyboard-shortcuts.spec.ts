...
test.describe("Keyboard Shortcuts", () => {
  ...
  test("Open new task editor with N key", async ({ page }) => {
    ...
    await expect(
      page.locator('text="Task created with N shortcut"'),
    ).toBeVisible();
  });
  ...
  test("Escape key behavior in task editor", async ({ page }) => {
    ...
    await expect(
      page.locator('[role="dialog"][data-testid="task-editor-panel"]'),
    ).not.toBeVisible();
    await expect(
      page.locator('text="This task will be cancelled"'),
    ).not.toBeVisible();
  });
  ...
  test("Escape key behavior in inline editor", async ({ page }) => {
    ...
    await expect(
      page.locator('text="Edited but will cancel"'),
    ).not.toBeVisible();
  });
  ...
  test("Save inline edit with Ctrl+Enter", async ({ page }) => {
    ...
    await expect(
      page.locator('text="Task to save with shortcut"'),
    ).not.toBeVisible();
  });
});
